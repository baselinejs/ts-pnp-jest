# ts-pnp-jest [![Production](https://github.com/baselinejs/ts-pnp-jest/actions/workflows/production.yml/badge.svg)](https://github.com/baselinejs/ts-pnp-jest/actions/workflows/production.yml)
